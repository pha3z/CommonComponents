...
namespace Common
{
    ...
    public class ObjectDumper
    {
        ...
        private ObjectDumper(bool singleLine, int depth, int indentSize, char indentChar)
        {
        ...
        public static string Dump(bool singleLine, object element, int depth = 4, int indentSize = 2, char indentChar = ' ')
        {
            var instance = new ObjectDumper(singleLine, depth, indentSize, indentChar);
