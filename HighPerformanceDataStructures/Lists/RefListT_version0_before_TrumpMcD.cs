...
namespace Faeric.HighPerformanceDataStructures
{
    ...
    public class RefList_Version0_Before_TrumpMcD<T>
    {
        ...
        private RefList_Version0_Before_TrumpMcD() { }

        public RefList_Version0_Before_TrumpMcD(int capacity)
        {
        ...
        public RefList_Version0_Before_TrumpMcD(int capacity, T defaultValue )
        {
        ...
        public RefList_Version0_Before_TrumpMcD<T> DeepCopy()
        {
            var newList = new RefList_Version0_Before_TrumpMcD<T>(Capacity);
